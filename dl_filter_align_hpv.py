...
def main(): 
    ...
    myparse.add_argument('-cpus', type=int, default=4, help="number of CPUS for processing")
   ...
   # cmd(["cd", args.sampleName])
    ...
    #         True, "{sampleName}.{i}.sai".format(sampleName=args.sampleName, i=i))
        ...
        cmd(
            ...
            True,"{topdir}/HPV.aligned.{i}.sam".format(topdir=topdirectory, sampleName=args.sampleName, i=i))
